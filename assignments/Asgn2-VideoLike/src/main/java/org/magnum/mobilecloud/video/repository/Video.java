...
public class Video {
	...
	public boolean userLikes(UserDetails u){
		return userLikes.contains(u.getUsername());
	}
	
	public void like(UserDetails u){
		if(userLikes(u))
			return;
		likes++;
		userLikes.add(u.getUsername());		
	}
	
	public void unlike(UserDetails u){
		if(userLikes(u)){
			likes--;
			userLikes.remove(u.getUsername());
		}
	}
